...
Start a container, taking note of any Environment variables a container expects.
...
Then start containers with a VIRTUAL_HOST (and the VIRTAL_PORT if more then one port is exposed) env variable:
